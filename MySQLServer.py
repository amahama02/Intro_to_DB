...
def create_alx_book_store_database():
    ...
    try:
        ...
        if cnx.is_connected():
            ...
            # 3. Define the SQL command to create the database.
            ...
            # 4. EXECUTE the SQL command. This is the crucial part that ensures the DB is created.
            cursor.execute(create_db_query)

            # 5. Commit the changes. This is necessary to apply the database creation.
            cnx.commit()

            # 6. Print the required success message.
        ...
        # 7. Handle specific MySQL connection or query execution errors.
        ...
        # 8. Close the cursor and the connection. This is vital to release server resources.
        if cursor:
            cursor.close()
